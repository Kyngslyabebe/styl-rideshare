  ...
  return (
    <View style={[styles.container, { backgroundColor: t.background }]}>
      ...
      <View style={styles.hero}>
        <View style={[styles.logoCircle, { backgroundColor: colors.orange }]}>
          <Text style={styles.logoText}>S</Text>
        </View>
        <Text style={[styles.brandName, { color: t.text }]}>styl</Text>
...
const styles = StyleSheet.create({
  ...
  logoCircle: { width: 72, height: 72, borderRadius: 36, justifyContent: 'center', alignItems: 'center', marginBottom: 18 },
  logoText: { fontSize: 32, fontWeight: '700', color: '#FFFFFF' },
  brandName: { fontSize: 48, fontWeight: '900', letterSpacing: -1 },
